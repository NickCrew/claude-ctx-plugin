"""Shell integration helpers for claude-ctx."""
...
BASH_ZSH_ALIASES = """
# Claude Context Export Aliases
# Generated by claude-ctx - for Warp AI and other terminal AI integrations
...
alias ctx-copy='claude-ctx export context - 2>/dev/null | pbcopy && echo "✓ Context copied to clipboard"'

# Quick management commands
alias ctx-agent-list='claude-ctx agent list'
alias ctx-mode-list='claude-ctx mode list'
alias ctx-tui='claude-ctx tui'
"""

# Function definitions for fish
FISH_FUNCTIONS = """
# Claude Context Export Functions
# Generated by claude-ctx - for Warp AI and other terminal AI integrations
...
# Helper to copy context to clipboard for pasting
function ctx-copy
    claude-ctx export context - 2>/dev/null | pbcopy; and echo "✓ Context copied to clipboard"
end
...
MARKER_START = "# >>> claude-ctx aliases >>>"
MARKER_END = "# <<< claude-ctx aliases <<<"
...
def install_aliases(
    ...
    """Install claude-ctx aliases into shell RC file.
...
def uninstall_aliases(
    ...
    """Uninstall claude-ctx aliases from shell RC file.
